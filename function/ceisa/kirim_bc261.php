<?php
function kirimbc261($username, $access_token, $nomor_aju, $sqlLib)
{
  $curl = curl_init();
  ...
  $sql="SELECT b.totalPrice as hargaPenyerahan, b.unitPrice as hargaSatuan, '1' as jumlahKemasan, b.quantity as jumlahSatuan, 
               b.itemNo as kodeBarang, '261' as kodeDokumen, b.satuan as kodeSatuanBarang, b.netto as netto, b.unitPrice as nilaiBarang, 
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS =>'{ 
        ...
        "nomorAju": "'.$nomor_aju.'",
        "seri":1,
        "tanggalAju": "'.$data_bc[0]['tglDaftar'].'",
