...
function kirimbc23($username, $access_token, $nomor_aju, $sqlLib)
{
  ...
  $sql_aju = "SELECT a.NoPO,a.NomorAju,a.DokumenBC,a.Urut,
              ...
              a.KodeBendera, a.NamaPengangkut, a.NomorPengangkut, a.KodeCaraAngkut, a.SeriPengangkut
  ...
  $sql = "SELECT a.KodeDokumen as kodeDokumen, a.JenisDokumen as jenisDokumen, a.TanggalDokumen as tanggalDokumen, a.NomorDokumen as nomorDokumen,
          ROW_NUMBER() OVER (ORDER BY a.SeriDokumen) AS seriDokumen
      FROM ms_dokumen_pendukung a
      WHERE a.NomorAju = '" . $nomor_aju . "'" ;    
  ...
  foreach ($data_dok as $dok) 
  {
    // Membuat array untuk setiap barang
      $dokumen_array = array(
          ...
          "seriDokumen" => intval($dok['seriDokumen'])
          );
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS =>'{
      ...
      "jumlahKontainer":1,
      "kodeAsuransi":"'.$data_aju[0]['KodeAsuransi'].'",
      "kodeDokumen":"23",
