<?php
function kirimbc27($username, $access_token, $nomor_aju, $sqlLib)
{
  $curl = curl_init();
  ...
  $sql="SELECT b.totalPrice as hargaPenyerahan, b.unitPrice as hargaSatuan, '1' as jumlahKemasan, b.quantity as jumlahSatuan, 
               b.itemNo as kodeBarang, '27' as kodeDokumen, b.satuan as kodeSatuanBarang, b.netto as netto, b.unitPrice as nilaiBarang, 
