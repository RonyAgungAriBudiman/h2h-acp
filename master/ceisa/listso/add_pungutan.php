...
$sqlLib = new sqlLib();
if ($_POST['seqitem'] == "") $_POST['seqitem'] = $_GET['seqitem'];
if (isset($_POST["simpan"])) {

    $sql = "INSERT INTO BC_BARANG_TARIF_TMP (SeqItem,KodePungutan, KodeTarif, Tarif, KodeFasilitas, TarifFasilitas, RecUser) 
                    VALUES ('" . $_POST["seqitem"] . "','" . $_POST["kodepungutan"] . "', '" . $_POST["kodetarif"] . "','" . $_POST["tarif"] . "', 
                            '" . $_POST["kodefasilitastarif"] . "','100',  '" . $_SESSION["nama"] . "')";
...
if (isset($_POST["delete"])) {
    $sql = "DELETE FROM BC_BARANG_TARIF_TMP WHERE SeqBT = '" . $_POST['seq'] . "'";
...
if (isset($_POST["edit"])) {
    $sql = "SELECT a.SeqBT, a.KodePungutan,
			...
			WHERE a.SeqBT ='" . $_POST['seqbt'] . "' ";
    $data = $sqlLib->select($sql);
    $_POST["kodepungutan"] = $data[0]['KodePungutan'];
    $_POST["kodetarif"] = $data[0]['KodeTarif'];
    $_POST["tarif"] = $data[0]['Tarif'];
    $_POST["kodefasilitastarif"] = $data[0]['KodeFasilitas'];
    $_POST["seq"] = $data[0]['SeqBT'];
}
if ($_GET['seq'] != '') {
    $sql = "SELECT a.SeqBT, a.KodePungutan,
            CASE WHEN a.KodeTarif='1' THEN 'Advalorum' 
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <select name="kodepungutan" class="form-control">
                                ...
                                <option value="BM" <?php if ($_POST['kodepungutan'] == "BM") {
                                                        echo "selected";
                                                    } ?>>BM</option>
                                <option value="PPN" <?php if ($_POST['kodepungutan'] == "PPN") {
                                                        echo "selected";
                                                    } ?>>PPN</option>
                                <option value="PPH" <?php if ($_POST['kodepungutan'] == "PPH") {
                                                        echo "selected";
                                                    } ?>>PPH</option>
                                <option value="PPNBM" <?php if ($_POST['kodepungutan'] == "PPNBM") {
                                                            echo "selected";
                                                        } ?>>PPNBM</option>
                            </select>
                        </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post" id="form" autocomplete="off" enctype="multipart/form-data">
                                                <input type="hidden" class="form-control" name="seqbt" value="<?php echo $row_tarif['SeqBT'] ?>">
                                                <input type="hidden" class="form-control" name="seqitem" value="<?php echo $_POST['seqitem'] ?>">
