		...
		<div class="card">
			<form method="post" id="form" autocomplete="off" enctype="multipart/form-data">
				<div class="form-group row mt-3 mb-0">
					...
					<div class="col-sm-3">
						<input type="text" placeholder="No SO" name="noso" id="noso" value="<?php echo $_POST['noso']; ?>" class="form-control">
					</div>
						...
						<table id="fixTable" class="table">
							<thead>
								<tr>
									...
									<th style="background-color:#133b5c; color:#FFF; padding: 2px;">No SO</th>
									<th style="background-color:#133b5c; color:#FFF; padding: 2px;">Tanggal</th>
									<th style="background-color:#133b5c; color:#FFF; padding: 2px;">Customer</th>
							...
							<tbody>
								...
								if ($_POST['noso'] != '') $sql .= " AND a.NoSO ='" . $_POST['noso'] . "' ";
								...
								?>
									<tr style="color:#000;">
										...
										<td style="text-align: center;"><?php echo trim($row['NoSO']) ?></td>
										<td style="text-align: center;"><?php echo date("d-M-Y", strtotime($row['TanggalSo'])); ?></td>
										<td style="text-align: left;"><?php echo trim($row['Customer']) ?></td>
										...
										<td style="text-align: center;">
											<div class="dropdown d-inline mr-2">
						                      ...
						                      <div class="dropdown-menu">
						                        <a class="dropdown-item" href="index.php?m=<?php echo acakacak("encode", "ceisa/listso") ?>&sm=<?php echo acakacak("encode", "add") ?>&p=<?php echo acakacak("encode", "Input Dokumen Aju") ?>&noso=<?php echo trim($row['NoSO']) ?>">Input Dokumen</a>
						                        <a class="dropdown-item" href="index.php?m=<?php echo acakacak("encode", "ceisa/listso") ?>&sm=<?php echo acakacak("encode", "upload") ?>&p=<?php echo acakacak("encode", "Upload Dokumen") ?>&noso=<?php echo trim($row['NoSO']) ?>">Upload Dokumen</a>
						                      </div>
						                    </div>
						                    <!--
											<?php if ($sisa > 0) { ?>
