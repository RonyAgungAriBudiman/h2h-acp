            ...
            <form method="post" id="form" autocomplete="off" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <label>Asal Bahan Baku</label>
                            <select name="kodeasalbahanbaku" class="form-control" required="required">
                                <option value=""></option>
                                <option value="0" <?php if($_POST['kodeasalbahanbaku']=="0") { echo "selected";} ?>>Import</option>
                                <option value="1" <?php if($_POST['kodeasalbahanbaku']=="1") { echo "selected";} ?>>Lokal</option>
