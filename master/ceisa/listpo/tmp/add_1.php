...
if ($_POST['simpan']) {
    ...
    if ($_POST['kodedokumenbc'] == "23") {
        ...
        $sql = "INSERT INTO ms_dokumen_aju (NoPO, NomorAju, DokumenBC, Urut, asalData,Seri, 
                    ...
                    NomorBc11, TglBc11, PosBc11, SubPosBc11, KodeCaraAngkut, NamaPengangkut, NomorPengangkut, KodeBendera, KodePelMuat, KodeTps,
             ...
             VALUES ('" . $_POST['nopo'] . "','" . $_POST["nomoraju"] . "','" . $_POST["kodedokumenbc"] . "','" . $_POST['urut'] . "','S','" . $_POST['seri'] . "',
                    ...
                    '" . $_POST["nomorbc11"] . "','" . $_POST["tglbc11"] . "','" . $_POST["posbc11"] . "','" . $_POST["subposbc11"] . "','" . $_POST["kodecaraangkut"] . "',
