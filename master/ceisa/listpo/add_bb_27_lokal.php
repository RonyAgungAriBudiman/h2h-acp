...
if (isset($_POST["simpan"])) {
    ...
    $sql = "INSERT INTO BC_BAHAN_BAKU_TMP (SeqItem,KodeAsalBahanBaku,HS,KodeBarang,Uraian,Cif,NDPBM,CifRupiah,HargaPenyerahan,HargaPerolehan,
            ...
            '" . $_POST["cif"] . "','" . $_POST["ndpbm"] . "','" . $cifrupiah . "','" . $_POST["hargapenyerahan"] . "','" . $_POST["hargaperolehan"] . "',
            '" . $_POST["jumlahsatuan"] . "','" . $_POST["kodedokumenasal"] . "','" . $_POST["kodekantorasal"] . "','" . $_POST["kodesatuan"] . "','" . $_POST["merek"] . "',
...
if ($_GET['seqbb'] != '') {
    ...
    $_POST["hargaperolehan"] = $data[0]['HargaPerolehan'];
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            ...
                                            <input type="text" name="hargaperolehan" id="hargaperolehan" class="form-control" required="required" value="<?php echo $_POST["hargaperolehan"] ?>" placeholder="0">
                                        </div>
                                        <div class="col-sm-12 mt-3">
