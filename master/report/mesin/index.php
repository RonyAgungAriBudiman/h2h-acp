        	...
        	<form method="post" id="form" autocomplete="off" enctype="multipart/form-data">
          		<div class="form-group row mt-3 mb-0">
                    ...
                    <div class="col-sm-3 ml-3">
                        ...
                        <a href="print/LapMesin.php?dari=<?php echo $_POST['dari'] ?>&sampai=<?php echo $_POST['sampai'] ?>&kodebarang=<?php echo $_POST['kodebarang'] ?>&namabarang=<?php echo $_POST['namabarang'] ?>" target="_blank">
                            <input type="button" class="btn btn-warning" name="cetak" Value="Cetak">
                        </a>

                        <a href="download/excel/LapMesin.php?dari=<?php echo $_POST['dari']; ?>&sampai=<?php echo $_POST['sampai']; ?>&kodebarang=<?php echo $_POST['kodebarang'] ?>&namabarang=<?php echo $_POST['namabarang'] ?>" target="_blank">
				            ...
				            $sql = "SELECT itemNo, itemName, unit1Name, itemCategory,
									...
									SELECT a.itemNo, a.itemName, a.unit1Name, a.itemCategory,
										sum(a.awal) as awal, sum(0) as masuk, sum(0) as keluar, 
											...
											sum(0) as selisih 
										FROM ac_stock a
									WHERE a.tanggal ='".$_POST['dari']."' AND a.lokasiGudang='Barang Modal'
									...
									SELECT a.itemNo, a.itemName, a.unit1Name, a.itemCategory,
										...
										FROM ac_stock a
									WHERE a.tanggal>='".$_POST['dari']."' AND a.tanggal<='".$_POST['sampai']."' AND a.lokasiGudang='Barang Modal'
									Group By a.itemNo, a.itemName, a.unit1Name, a.itemCategory, a.lokasiGudang 
									) as tbl
									Group By itemNo, itemName, unit1Name, itemCategory " ;
