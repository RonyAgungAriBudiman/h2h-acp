          		...
          		<div class="form-group row mt-3 mb-0">
                    ...
                    <div class="col-sm-2">
                        <select name="dokbc" class="form-control">
                            ...
                            <?php
                            $sql_com = "SELECT DISTINCT dokumenBC FROM ac_pengeluaran  WHERE dokumenBC !='' ";
                    ...
                    <div class="col-sm-3 ml-3">
                        ...
                        <a href="print/LapPengeluaranBarang.php?dari=<?php echo $_POST['dari'] ?>&sampai=<?php echo $_POST['sampai'] ?>&dokbc=<?php echo $_POST['dokbc'] ?>&kodebarang=<?php echo $_POST['kodebarang'] ?>&namabarang=<?php echo $_POST['namabarang'] ?>" target="_blank">
                            <input type="button" class="btn btn-warning" name="cetak" Value="Cetak">
                        </a>
                        <a href="download/excel/LapPengeluaranBarang.php?dari=<?php echo $_POST['dari']; ?>&sampai=<?php echo $_POST['sampai']; ?>&dokbc=<?php echo $_POST['dokbc'] ?>&kodebarang=<?php echo $_POST['kodebarang'] ?>&namabarang=<?php echo $_POST['namabarang'] ?>" target="_blank">
                            <input type="button" name="export" class="btn btn-success" value="Export">\
                        </a> 
					...
					<table id="fixTable" class="table">
				        <thead>
				            <tr>
				                ...
				                <th style="background-color:#133b5c; color:#FFF; padding: 2px;" colspan="2" style="text-align:center;">Bukti/Dokumen Pengeluaran</th>
				                <th style="background-color:#133b5c; color:#FFF; padding: 2px;" rowspan="2">Pembeli/Peneriman</th>
				        ...
				        <tbody>
				            ...
				            $sql = "SELECT a.dokumenBC, a.nomorAju, a.nomorDaftar, a.tglDaftar,  a.customer, a.DO, a.tglDO,
				                    ...
				                    WHERE a.tglDaftar>='".$_POST['dari']."' AND a.tglDaftar<='".$_POST['sampai']."' ";
				                     ...
				                     if($_POST['namabarang']!='') $sql .=" AND b.itemNo='".$_POST['kodebarang']."'";  
				            ...
				            {	
				                ...
				                <tr style="color:#000;">
				                    ...
				                    <td style="text-align: left;"><?php echo $row['detailName'] ?></td>
